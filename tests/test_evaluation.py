...
def test_numeric_answer_correctness() -> None:
    result = numeric_answer_correctness("OpenHands costs $6.38 in 362.41 seconds", ["6.38", "362.41"])
...
def test_citation_correctness() -> None:
    chunk = DocumentChunk(chunk_id="p005-0002", text="...", page=5, section="4.1", chunk_type="result")
...
def test_graded_relevance() -> None:
    chunk = DocumentChunk(
        chunk_id="x", text="DevAI has 55 tasks and 365 requirements", page=1, section="s", chunk_type="n"
    )
...
def test_all_key_values_present_in_raw_chunks() -> None:
    ...
    key_values = ["6.38", "362.41", "1.19", "44.80", "97.72", "97.64", "90.44", "60.38",
                  "65.03", "75.95", "82.24", "86.06", "87.70", "85.52", "23.77", "30.58",
                  "118.43", "86.5", "1080p", "cn9o", "svm", "lstm", "metagpt", "gpt-pilot", "openhands"]
